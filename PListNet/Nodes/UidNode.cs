...
namespace PListNet.Nodes
{
    ...
    public class UidNode : PNode<ulong>
    {
        ...
        internal override byte BinaryTag { get { return 8; } }
        ...
        internal override int BinaryLength
        {
            get
            {
                ...
                if (Value <= uint.MaxValue) return 2;
                if (Value <= ulong.MaxValue) return 3;
        ...
        internal override void ReadBinary(Stream stream, int nodeLength)
        {
            ...
            switch (nodeLength)
            {
                case 0:
                    ...
                    break;
                case 1:
                    Value = (ulong)EndianConverter.NetworkToHostOrder(BitConverter.ToUInt16(buf, 0));
                    break;
                case 2:
                    Value = (ulong)EndianConverter.NetworkToHostOrder(BitConverter.ToUInt32(buf, 0));
                    break;
                case 3:
                    Value = (ulong)EndianConverter.NetworkToHostOrder((long)BitConverter.ToUInt64(buf, 0));
                    break;
                default:
        ...
        internal override void WriteBinary(Stream stream)
        {
            ...
            switch (BinaryLength)
            {
                case 0:
                    ...
                    break;
                case 1:
                    buf = BitConverter.GetBytes((ulong)EndianConverter.HostToNetworkOrder((short)Value));
                    break;
                case 2:
                    buf = BitConverter.GetBytes((ulong)EndianConverter.HostToNetworkOrder((Int32)Value));
                    break;
                case 3:
                    buf = BitConverter.GetBytes((ulong)EndianConverter.HostToNetworkOrder((long)Value));
                    break;
            }
